...
# Доработать пагинатор - на второй странице при активном фильтре фильтр ломается
...
#Доработать автор лист фильтр чтобы не показывать атворов с 0-м количеством новостей
